    ...
    <div class="itemslist">
        <div class="item item1">
            <div class="text">
                ...
                <button type="Submit" name="btitem1" id="btitem1">Acheter -40<img class="piece" src="../images/piece.png" alt="PA"></button>
            </div>
        </div>
        <div class="item item2">
            <div class="text">
                <h2>objet2</h2></br>
                <p>loremaze azezae aezaze azeeaz eazea eaz eaze aze</p></br>
                <button type="Submit" name="btitem2" id="btitem2">Acheter -50<img class="piece" src="../images/piece.png" alt="PA"></button>
            </div>
        </div>
        <div class="item item3">
            <div class="text">
                <h2>objet3</h2></br>
                <p>loremaze azezae aezaze azeeaz eazea eaz eaze aze</p></br>
                <button type="Submit" name="btitem3" id="btitem3">Acheter -60<img class="piece" src="../images/piece.png" alt="PA"></button>
            </div>
        </div>
        <div class="item item4">
            <div class="text">
                <h2>objet4</h2></br>
                <p>loremaze azezae aezaze azeeaz eazea eaz eaze aze</p></br>
                <button type="Submit" name="btitem4" id="btitem4">Acheter -70<img class="piece" src="../images/piece.png" alt="PA"></button>
            </div>
        </div>
    </div>
</form>
